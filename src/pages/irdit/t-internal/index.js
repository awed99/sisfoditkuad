...
const MUITable = () => {
  ...
  const columns = [
    ...
    { field: 'kukotama', headerName: 'Kukotama', width: 120 },
    {
      field: 'intl',
      headerName: 'INTL',
      width: 100,
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Temuan Internal</Link>
        </Typography>
        <Typography variant='body2'>Data Temuan Internal</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
      ...
      <ModalDialog
        titleModal='Detail Data Temuan Internal'
        openModal={openModal}
        setOpenModal={setOpenModal}
        handleSubmitFunction={() => setOpenModal(false)}
      >
        <Box style={{ width: 550 }}>Detail Data Temuan Internal</Box>
      </ModalDialog>
    </Grid>
  )
}
