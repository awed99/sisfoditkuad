...
const MUITable = () => {
  ...
  const columns = [
    ...
    { field: 'kukotama', headerName: 'Kukotama', width: 400 },
    {
      field: 'kinerja',
      headerName: 'Kinerja',
      width: 200,
    ...
    {
      field: 'perbendaharaan',
      headerName: 'Perbendaharaan',
      width: 200,
      align: 'left'
  ...
  const columnGroupingModel = [
    {
      groupId: 'Temuan',
      description: '',
      children: [{ field: 'kinerja' }, { field: 'perbendaharaan' }, { field: 'administrasi' }]
    }
  ]
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Temuan Itjen Kemhan</Link>
        </Typography>
        <Typography variant='body2'>Data Temuan Itjen Kemhan</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
      ...
      <ModalDialog
        titleModal='Detail Data Temuan Itjen Kemhan'
        openModal={openModal}
        setOpenModal={setOpenModal}
        handleSubmitFunction={() => setOpenModal(false)}
      >
        <Box style={{ width: 550 }}>Detail Data Temuan Itjen Kemhan</Box>
      </ModalDialog>
    </Grid>
  )
}
