    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Temuan Itjen TNI AD</Link>
        </Typography>
        <Typography variant='body2'>Data Temuan Itjen TNI AD</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
      ...
      <ModalDialog
        titleModal='Detail Data Temuan Itjen TNI AD'
        openModal={openModal}
        setOpenModal={setOpenModal}
        handleSubmitFunction={() => setOpenModal(false)}
      >
        <Box style={{ width: 550 }}>Detail Data Temuan Itjen TNI AD</Box>
      </ModalDialog>
    </Grid>
  )
}
