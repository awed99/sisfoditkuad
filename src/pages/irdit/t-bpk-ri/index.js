    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Temuan BPK RI</Link>
        </Typography>
        <Typography variant='body2'>Data Temuan BPK RI</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
      ...
      <ModalDialog
        titleModal='Detail Data Temuan BPK RI'
        openModal={openModal}
        setOpenModal={setOpenModal}
        handleSubmitFunction={() => setOpenModal(false)}
      >
        <Box style={{ width: 550 }}>Detail Data Temuan BPK RI</Box>
      </ModalDialog>
    </Grid>
  )
}
