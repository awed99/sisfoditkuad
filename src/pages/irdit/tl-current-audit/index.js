    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Tindak Lanjut Post Audit</Link>
        </Typography>
        <Typography variant='body2'>Data Tindak Lanjut Post Audit</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
      ...
      <ModalDialog
        titleModal='Detail Data Tindak Lanjut Post Audit'
        openModal={openModal}
        setOpenModal={setOpenModal}
        handleSubmitFunction={() => setOpenModal(false)}
      >
        <Box style={{ width: 550 }}>Detail Data Tindak Lanjut Post Audit</Box>
      </ModalDialog>
    </Grid>
  )
}
