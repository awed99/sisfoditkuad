    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Dokumen Peraturan Ditkuad</Link>
        </Typography>
        <Typography variant='body2'>Semua Dokumen Peraturan Ditkuad</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          {/* <CardHeader title='Kumpulan Dokumen Peraturan Ditkuad' titleTypographyProps={{ variant: 'h6' }} /> */}
