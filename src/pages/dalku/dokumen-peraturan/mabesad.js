    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          <Link>Dokumen Peraturan Mabesad</Link>
        </Typography>
        <Typography variant='body2'>Semua Dokumen Peraturan Mabesad</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          {/* <CardHeader title='Kumpulan Dokumen Peraturan Mabesad' titleTypographyProps={{ variant: 'h6' }} /> */}
